...
class EditTaskDialog(QDialog):
    ...
    def load_task_info(self):
        ...
        idx = self.editStatus.findText(status)
        if idx == -1:
            idx = 0
        self.editStatus.setCurrentIndex(idx)

    # save the edited task back to tasks list
    def save_task(self):
        ...
        newStatus = self.editStatus.currentText().strip()
